Feature: Verifying the functionality of Create account link and Verifying module with valid/invalid data.
	...
	Scenario Outline: Verifying the functionality of Create account link on Landing page and with invalid email type of MAPFRE.
		...
		Examples:
	    		...
	    		|demo@gmail          |admin       | admin     |Please Enter A Valid Email|
	            |de@mo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |demo                |admin       | admin     |Please Enter A Valid Email|
	            |.demo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |demo.@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |de..mo@gmail.com    |admin       | admin     |Please Enter A Valid Email|
	            |_demo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |demo_@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |de__mo@gmail.com    |admin       | admin     |Please Enter A Valid Email|
	            |de~mo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |de!mo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |de#mo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
	            |de$mo@gmail.com     |admin       | admin     |Please Enter A Valid Email|
